                    ...
                    <tr>
                        <td>
                            <table border="0" cellpadding="0" cellspacing="0" width="400" bgcolor="white" align="center"  style="max-width:400px;">
                                ...
                                <tr>
                                    <td>
                                        <p style = "color:black; font-family: Calibri,Arial,sans-serif; font-style: italic; margin-top: 10px;">To unsubscribe from future newsletters. Please visit the following page. <a href="{{env('APP_URL')}}/queries/unsub">Unsubscribe</a></p>
                                    </td>
                                </tr>
