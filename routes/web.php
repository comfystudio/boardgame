...
//Route::get('/games/{type?}', 'NewsController@index');
Route::get('/all', 'NewsController@index');
Route::get('/games', 'NewsController@index');
Route::get('/kickstarters', 'NewsController@index');
Route::get('/aob', 'NewsController@index');
Route::get('/view/{slug}', 'NewsController@view');


//Route::get('games/{category?}', function($category = 'John')
//{
//    return $category;
//});
